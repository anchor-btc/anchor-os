...
const CARRIERS: Carrier[] = [
  {
    ...
    icon: '📜',
    description:
      'Classic method. Up to 80 bytes in a single OP_RETURN output. Prunable and efficient.',
  ...
  },
  {
    ...
    icon: '✨',
    description:
      'Ordinals-style inscriptions in witness data. Supports larger payloads and complex data.',
  ...
  },
  {
    ...
    icon: '🔐',
    description:
      'SegWit witness field for arbitrary data. Leverages witness discount for lower fees.',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Anchor Protocol supports{' '}
            <span className="text-accent font-semibold">multiple carriers</span> for embedding data.
        ...
        >
          <svg viewBox="0 0 700 300" className="w-full h-auto" style={{ minHeight: 300 }}>
            {/* Connection Lines */}
            <defs>
              <marker
                id="arrowhead"
                ...
                orient="auto"
              >
                <polygon points="0 0, 10 3.5, 0 7" fill={hoveredPart ? '#f59e0b' : '#52525b'} />
              </marker>
            ...
            <motion.line
              ...
              y2="225"
              stroke={
                hoveredPart === 'tx' || hoveredPart === 'carrier'
                  ? 'url(#carrierGradient)'
                  : '#52525b'
              }
              strokeWidth="2"
