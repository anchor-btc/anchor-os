...
const stackLayers: StackLayer[] = [
  {
    ...
    description: "Modern web interface to manage your entire Bitcoin infrastructure. Monitor services, configure apps, and interact with the blockchain from one place.",
    color: "#f97316",
    icon: "🖥️",
  ...
  },
  {
    ...
    shortLabel: "Apps",
    description: "Decentralized applications running on your node. Each app is independently containerized and communicates through the shared API layer.",
    color: "#3b82f6",
    icon: "📦",
    components: ["Threads", "Canvas", "Places", "Proofs", "Domains", "Tokens", "Oracles", "Predictions"],
  },
  {
    id: "indexer",
    label: "Anchor Indexer",
    shortLabel: "Indexer",
    description: "Parses and indexes Anchor Protocol messages from the blockchain. Provides a REST API for querying on-chain data efficiently.",
    color: "#8b5cf6",
    icon: "🔍",
  ...
  },
  {
    ...
    shortLabel: "Electrum",
    description: "Indexes addresses and transactions for wallet connectivity. Choose between Electrs (lightweight) or Fulcrum (high-performance).",
    color: "#eab308",
    icon: "⚡",
  ...
  },
  {
    ...
    label: "Bitcoin Core",
    shortLabel: "Bitcoin",
    description: "The foundation of your stack. Full node with complete transaction and block validation. Your keys, your node, your rules.",
    color: "#f97316",
    icon: "₿",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            ...
            Click on any layer to learn more about its components.
          </p>
        </motion.div>
            ...
            {stackLayers.map((layer, index) => (
              <motion.button
                ...
                style={{
                  ...
                  backgroundColor: selectedLayer === layer.id ? `${layer.color}15` : 'rgba(255,255,255,0.03)',
                }}
              >
                ...
                {activeLayer ? (
                  ...
                  >
                    ...
                    <p className="text-muted-foreground max-w-sm">
                      Click on any layer on the left to see detailed information about its components and functionality.
                    </p>
