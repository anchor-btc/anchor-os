      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            A beautiful, intuitive dashboard to manage your entire Bitcoin stack. 
            Monitor, control, and explore — all in one place.
          </p>
        </motion.div>
                ...
                <div className="w-64 bg-card/50 border-r border-white/5 p-4">
                  ...
                  <div className="space-y-1">
                    {["Threads", "Map", "Pixel", "Proof"].map((app) => (
                      <div key={app} className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-muted-foreground hover:text-foreground transition-colors">
                ...
                <div className="flex-1 p-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    {[
                      ...
                      <div key={stat.label} className="p-4 rounded-xl bg-card/50 border border-white/5">
