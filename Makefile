...
help:
	...
	@echo ""
	@echo "  Docker Compose:"
	@echo "    make up            Start default profile (core + dashboard + apps)"
	@echo "    make up-full       Start all services including explorers"
	@echo "    make up-min        Start minimum (core + dashboard only - for setup)"
