//! API handlers for Anchor Lottery
...
use crate::models::{
    BuyTicketRequest, ClaimPrizeRequest, CreateLotteryRequest, DlcContract,
...
pub async fn health() -> impl IntoResponse {
    Json(serde_json::json!({ "status": "ok", "service": "anchor-lottery" }))
}
