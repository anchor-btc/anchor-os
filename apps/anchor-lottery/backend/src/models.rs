//! Data models for Anchor Lottery

use serde::{Deserialize, Serialize};
use utoipa::ToSchema;

/// Lottery types
pub mod lottery_type {
    pub const DAILY: i32 = 0;
    pub const WEEKLY: i32 = 1;
    pub const JACKPOT: i32 = 2;
}

/// Token types
pub mod token_type {
    pub const BTC: i32 = 0;
    pub const ANCHOR_TOKEN: i32 = 1;
}
