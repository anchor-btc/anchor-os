...
import { Eye, AlertCircle, RefreshCw, Plus, Zap, Wallet } from "lucide-react";
import Link from "next/link";
import { fetchOraclesByAddresses, Oracle } from "@/lib/api";
...
export default function MyOraclesPage() {
  ...
  const { data: myOracles = [], isLoading: isLoadingOracles, refetch } = useQuery({
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-2">
            Oracles registered with your Nostr identities
          </p>
        </div>
