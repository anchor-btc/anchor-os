...
/// AnchorMap indexer that scans the blockchain for marker transactions
...
impl MarkerIndexer {
    ...
    pub async fn start(self: Arc<Self>) -> Result<()> {
        ...
        info!("Starting AnchorMap indexer");
        ...
        info!("AnchorMap indexer stopped");
        Ok(())
    }
