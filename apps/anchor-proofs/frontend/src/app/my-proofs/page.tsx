...
export default function MyProofsPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-slate-400 mb-8">View all proofs created by your wallet addresses.</p>
      ...
      {data && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4">
            ...
            <p className="text-2xl font-bold text-white">{data.total_proofs}</p>
          </div>
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-2xl font-bold text-white">{data.unique_transactions}</p>
          </div>
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-2xl font-bold text-white">{data.proofs.length} proofs</p>
          </div>
        </div>
      )}
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">No proofs found</h2>
          <p className="text-slate-400 mb-6 max-w-md mx-auto">
            You haven&apos;t created any proofs yet. Start by stamping a file to create your first
            proof of existence.
          </p>
          <Link
            href="/stamp"
