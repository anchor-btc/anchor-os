...
export default function ValidatePage() {
  ...
  const validateMutation = useMutation({
    mutationFn: async () => {
      ...
      return validateHash(
        hash,
        selectedAlgo === HashAlgorithm.SHA256 ? "sha256" : "sha512"
      );
    },
    onSuccess: (data) => {
    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-slate-400 mb-8">
          Verify if a file has been timestamped on Bitcoin. Upload the file and we will
          check if its hash exists in our records.
        </p>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-emerald-300">
                        This file has been timestamped on Bitcoin
                      </p>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-red-300">
                        No proof of existence found for this file
                      </p>
                    </div>
                  </>
                )}
