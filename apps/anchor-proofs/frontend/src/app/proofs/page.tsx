...
import { Search, List, ChevronLeft, ChevronRight, Loader2, Filter } from 'lucide-react';
    ...
    <main className="max-w-6xl mx-auto px-4 py-12">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20">
          ...
          {search && (
            <button onClick={handleClearSearch} className="mt-4 text-emerald-500 hover:underline">
              Clear search
            </button>
          )}
        </div>
