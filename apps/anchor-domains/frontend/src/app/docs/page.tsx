    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-slate-400 mb-8">
          Learn how Anchor Domains works and how to integrate it into your applications.
        </p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-800/50 rounded-xl border border-slate-700 p-6">
            <p className="text-slate-300 mb-4">
              Anchor Domains is a decentralized Domain Name System built on Bitcoin using the
              Anchor protocol. It allows users to register <code className="px-1 py-0.5 bg-slate-700 rounded">.btc</code>, <code className="px-1 py-0.5 bg-slate-700 rounded">.sat</code>, <code className="px-1 py-0.5 bg-slate-700 rounded">.anchor</code>, <code className="px-1 py-0.5 bg-slate-700 rounded">.anc</code>, and <code className="px-1 py-0.5 bg-slate-700 rounded">.bit</code> domains
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-800/50 rounded-xl border border-slate-700 p-6 space-y-4">
            <div className="p-4 bg-slate-700/30 rounded-lg">
              ...
              <p className="text-sm text-slate-400">Resolve a domain by name (e.g., mysite.btc)</p>
            </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-slate-800/50 rounded-xl border border-slate-700 p-6">
            <p className="text-slate-300 mb-4">
              Install the Anchor Domains Chrome extension to resolve .btc, .sat, .anchor, .anc, .bit domains directly in your browser.
              The extension intercepts requests to these domains and redirects them to the resolved IP address.
            </p>
            <div className="p-4 bg-slate-700/30 rounded-lg">
