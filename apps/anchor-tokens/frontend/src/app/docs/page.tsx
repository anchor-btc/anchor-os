      ...
      <div className="space-y-8">
        ...
        <section className="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
          ...
          <p className="text-gray-300 mb-4">
            Anchor Tokens is a UTXO-based token protocol built on the Anchor Protocol. Similar to
            Bitcoin Runes, tokens are attached to Bitcoin UTXOs, enabling:
          </p>
        ...
        <section className="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gray-900/50 rounded-lg">
              ...
              <p className="text-gray-400 text-sm">
                Transfer tokens from input UTXOs to output addresses. Uses anchors to reference
                source UTXOs.
              </p>
            </div>
        ...
        <section className="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
          ...
          <div className="mt-4 p-4 bg-gray-900/50 rounded-lg">
            <p className="text-sm text-gray-400">
              <strong className="text-white">Example:</strong> A single transfer using OP_RETURN
              costs ~180 sats @ 1 sat/vB. Using Witness Data, the same transfer costs only ~45 sats.
            </p>
          </div>
        </section>
        ...
        <section className="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Uses <code className="px-2 py-1 bg-gray-900 rounded">AnchorKind::Custom(20)</code>{' '}
                to identify token messages.
              </p>
            </div>
...
SPLIT:  [0x05][token_id][count][[output_idx][amount]...]`}
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Tokens are identified by their deploy transaction. The indexer assigns a sequential
                ID for efficient varint encoding in subsequent operations.
              </p>
            </div>
          </div>
        </section>
