...
export const apps: App[] = [
  ...
  },
  {
    ...
    backendPort: 3801,
    containers: [
      'anchor-app-predictions-frontend',
      'anchor-app-predictions-backend',
      'anchor-app-predictions-postgres',
    ],
    containerConfigs: [
  ...
  },
  {
    ...
    backendPort: 3701,
    containers: [
      'anchor-app-oracles-frontend',
      'anchor-app-oracles-backend',
      'anchor-app-oracles-postgres',
    ],
    containerConfigs: [
  ...
  },
  {
    ...
    port: 4000,
    containers: [
      'anchor-explorer-mempool-web',
      'anchor-explorer-mempool-api',
      'anchor-explorer-mempool-db',
    ],
    containerConfigs: [
