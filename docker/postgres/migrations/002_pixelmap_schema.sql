...
-- PixelMap indexer state (separate from main anchor indexer)
CREATE TABLE IF NOT EXISTS pixelmap_indexer_state (
    id INTEGER PRIMARY KEY DEFAULT 1,
    last_block_hash BYTEA,
    last_block_height INTEGER DEFAULT 0,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    CONSTRAINT pixelmap_single_row CHECK (id = 1)
);

-- Initialize pixelmap indexer state
INSERT INTO pixelmap_indexer_state (id, last_block_height) 
VALUES (1, 0) 
